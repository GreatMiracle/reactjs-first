                            ...
                            msg.read ? (
                              <>
                                {
                                  receipentUserId.profilePic ? (
                                    <div className='rounded-full w-10 h-10 flex items-center justify-center mx-1 relative'>
                                      <img src={receipentUserId.profilePic}
                                        alt='profile Pic'
                                        className='w-3 h-3 rounded-full absolute bottom-0 left-0'
                                      />
                                    </div>
                                  ) : (
                                    <div className='relative w-10 h-10'>
                                      <div
                                        className=" text-white rounded-full w-4 h-4 flex items-center justify-center mx-1 absolute bottom-0 left-0" >
                                        <i className='ri-checkbox-circle-line text-sm font-semibold text-blue-500' />
                                      </div>
                                    </div>
                                  )
                                }
                              ...
                              <>
                                <div className='relative w-10 h-10'>
                                  <div
                                    className=" text-white rounded-full w-4 h-4 flex items-center justify-center mx-1 absolute bottom-0 left-0" >
                                    <i className='ri-checkbox-circle-line text-sm font-semibold text-gray-400' />
                                  </div>
                                </div>
                              </>
                            )
